...
pool.query(createPostsTable)
    ...
    .catch(err => {
        console.error('Error in creating posts table: ' + err.message);
    });
...
pool.query(createUsersTable)
    ...
    .catch(err => {
        console.error('Error in creating users table: ' + err.message);
    });
...
router.post('/signup', async function(req, res) {
    ...
    bcrypt.hash(password, saltRounds, async function(err, hash) {
        ...
        try {
            ...
            console.error('Error in inserting user: ' + err.message);
...
router.post('/login', async function(req, res) {
    ...
    try {
        ...
        console.error('Error in fetching user: ' + err.message);
...
router.post('/write', upload.single('file'), async function(req, res) {
    ...
    try {
        ...
        console.error('Error in inserting post: ' + err.message);
